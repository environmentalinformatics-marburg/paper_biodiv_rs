...
mgpm = lapply(seq(length(belc)), function(i){
  ...
  col_precitors = seq(grep("G_std_glb",
                           names(act_m_df)),
                      grep("LUI_glb",
                           names(act_m_df)))
...
saveRDS(mgpm, "C:/Users/tnauss/permanent/plygrnd/exploratorien/data/manning/cwm_mgpm_lui.rds")
...
for(be in names(mgpm)){
  ...
  mgpm[[be]] = trainModel(x = mgpm[[be]],
                          ...
                          filepath_tmp = NULL)
  saveRDS(mgpm[[be]], file = paste0("C:/Users/tnauss/permanent/plygrnd/exploratorien/data/manning/", be, "_lui.rds"))
  stopCluster(cl)
}
# saveRDS(mgpm, file = paste0("C:/Users/tnauss/permanent/plygrnd/exploratorien/data/manning/cmw_mgpm_model_lui.rds"))
