...
############################
# SPECIFY the model
  # the FINAL response remain the same for all approaches
  veg_re_g_gpm_indv$AEG@meta$input$RESPONSE_FINAL<-veg_re_g_gpm_indv$AEG@meta$input$RESPONSE_FINAL[c(1,14:22)]
